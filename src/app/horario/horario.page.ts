...
import { Horario } from '../shared/horario.interface';
...
export class HorarioPage implements OnInit {
  ...
  getMateria() {
   ...
   //this.authService.createMateriaJson();
   this.authService.upadteMateriaJson();


/*
    this.authService.getMateriaPrueba().subscribe((query)=>{
